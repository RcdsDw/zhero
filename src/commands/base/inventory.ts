...
export const data = new SlashCommandBuilder().setName('inventory').setDescription('Affiche votre inventaire');
...
export async function execute(interaction: CommandInteraction) {
    ...
    interaction.reply(await ItemBuilder.inventory(user, interaction.user));
}
